...
class ObjectCounter(BaseSolution):
    ...
    def __init__(self, load_model = False, names = None, **kwargs):
        ...
        if load_model:
            ...
            self.names = names  # No names associated if model is not loaded
    ...
    def count(self, im0, precomputed_results):
        """
        ...
        self.extract_tracks(precomputed_results)  # Extract tracks
